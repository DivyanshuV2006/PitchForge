...
object NotificationCopy {
    ...
    private val HABIT_WITH_HISTORY = listOf(
        ...
        Message("Absolute pitch, daily", "Small sessions add up. Open ChromaP and take the next step."),
    ...
    private val HABIT_NO_HISTORY = listOf(
        ...
        Message("Your first notes await", "No pressure, just curiosity. Open ChromaP and listen."),
        ...
        Message("Welcome back to sound", "Whenever you're ready, ChromaP is here for a friendly warm-up."),
    ...
    private val HABIT_AFTER_MISS = listOf(
        ...
        Message("Pick the thread back up", "Gaps happen. The win is opening ChromaP again — even one lesson rebuilds momentum."),
    ...
    private val SECOND_SESSION = listOf(
        ...
        Message("Encore available", "ChromaP is ready for a second lesson whenever you are."),
    ...
    private val REVIEW = listOf(
        ...
        Message("Memory boost available", "Open ChromaP for a quick spaced-review session."),
    ...
    private val RETENTION = listOf(
        ...
        Message("Long-term ear test", "See if those notes stuck. Open ChromaP for a quick check."),
    ...
    private val GENERALIZATION = listOf(
        ...
        Message("Transfer test ready", "Open ChromaP and see if absolute pitch follows you across instruments."),
    ...
    private val CHECKUP = listOf(
        ...
        Message("End-of-month listen", "ChromaP's monthly AP checkup is open. Short and insightful."),
